    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_cinema', models.CharField(help_text='Input name Cinema', max_length=300, validators=[django.core.validators.MinLengthValidator(10)])),
                ('description_cinema', models.TextField(blank=True, help_text='Input description Cinema', null=True)),
                ('logo_cinema', models.ImageField(blank=True, editable=False, help_text='Upload an image. Supported formats: JPEG, PNG', null=True, upload_to='static/photos/%Y/%m/%d/')),
                ('main_foto_cinema', models.ImageField(blank=True, editable=False, help_text='Upload an image. Supported formats: JPEG, PNG', null=True, upload_to='static/photos/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_gallery', models.CharField(help_text='Input name Gallery', max_length=300, validators=[django.core.validators.MinLengthValidator(10)])),
            ],
        ),
        migrations.CreateModel(
            name='GalleryPhotos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_shem_hall', models.ImageField(blank=True, editable=False, help_text='Upload an image. Supported formats: JPEG, PNG', null=True, upload_to='static/photos/%Y/%m/%d/')),
                ('main_foto_hall', models.ImageField(blank=True, editable=False, help_text='Upload an image. Supported formats: JPEG, PNG', null=True, upload_to='static/photos/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_seo', models.CharField(help_text='Input title SEO', max_length=300, validators=[django.core.validators.MinLengthValidator(10)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('row', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cinema.rows')),
                ('seat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cinema.seats')),
            ],
        ),
        migrations.AddField(
            model_name='seats',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(editable=False, help_text='Upload an image. Supported formats: JPEG, PNG', upload_to='static/photos/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_movie', models.CharField(help_text='Input name Movie', max_length=300, validators=[django.core.validators.MinLengthValidator(10)])),
                ...
                ('main_foto_movie', models.ImageField(blank=True, editable=False, help_text='Upload an image. Supported formats: JPEG, PNG', null=True, upload_to='static/photos/%Y/%m/%d/')),
